...
% computing hours worked (labor) at each date as described in the article 
...
am(1)=ass*0.5;  % the lower bound on a(t)
am(100)=ass*2;  % the upper bound on a(t)
   
% 3. Load the shocks
% ------------------
load shock; tet=tet(1:T,1);  % load shocks 
...
for t=1:T;
   ...
   n(t)=csolve('labor',(1-lss),[],0.000001,5,nu,alpha,at);
